                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-4">
                                {["Find Hostels", "Book a Room", "Instant Payments", "Reviews", "Student-Landlord Chat"].map((service) => (
                                    <li key={service}>
                                        <a href="#" className="text-gray-400 hover-text-purple-400 transition-colors duration-200">{service}</a>
                                    </li>
                                ))}
                            </ul>
                        </div>
