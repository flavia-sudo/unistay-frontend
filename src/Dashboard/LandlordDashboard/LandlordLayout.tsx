...
import LandlordDrawer from "../LandlordDashboard/aside/LandlordDrawer";
    ...
    <div className="flex min-h-screen">
      ...
      {drawerOpen &&(
        ...
        >
            <div className="fixed inset-y-0 left-0 w-64 bg-gray-900 z-50">
                <LandlordDrawer onClose={() => setDrawerOpen(false)}/>
            </div>
        </div>
        </>
      )}
      ...
      <div className="flex-1 flex flex-col ml-4">
        ...
        <div className="md:hidden flex items-center bg-gray-900 text-white p-4">
            ...
            <h1 className="text-lg font-bold">Landlord Dashboard</h1>
        </div>
